...
class NaughtyOutputBehaviourFeedbackGenerator:
    ...
    def handle_invalid_som_location_error(self) -> str:
        ...
        return "The action you generated contained an invalid location marker, causing you to skip your turn. Double check that the location marker in your action corresponds to a valid location in the frame and try again."

    def handle_out_of_bounds_coordinate_error(self) -> str:
        """Handle out of bounds coordinate feedback."""
        return "The action you generated contained an out-of-bounds coordinate, causing you to skip your turn. Ensure that all coordinates you use in your actions are within the valid range and try again."

    def handle_server_error(self) -> str:
        """Handle server error feedback."""
        return "There was a server error while you were generating your response, causing you to skip your turn. Try again!"

    def handle_invalid_format(self) -> str:
        """Handle invalid format feedback."""
        return "The response you generated was in an invalid format, causing you to skip your turn. Double check and correct the format of your response and try again."

    def handle_max_tokens_exceeded(self) -> str:
        """Handle max tokens exceeded feedback."""
        return "It seems like your thoughts or message were too verbose and you exhausted your word limit, causing you to skip your turn. Use fewer words and be more concise in your thoughts, and try again."

    def handle_unknown_error(self) -> str:
        """Handle unknown error feedback."""
        return "An unknown error occurred while processing your output, causing you to skip your turn."
