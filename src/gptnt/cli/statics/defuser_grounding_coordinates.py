...
from gptnt.evaluation.postprocess import convert_normalised_to_absolute, default_postprocess
from gptnt.evaluation.preprocess import preprocess_grounding_coordinates_instance
from gptnt.evaluation.prompts import (
