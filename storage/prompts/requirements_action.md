...
- Use the "interact_game" command with the "click_release" action first to activate a module before attempting any interaction. This is essential for proper game mechanics.
...
- Ensure that the specific object you want to interact with has a Location Marker associated with it. If it does not, you cannot interact with from your current perspective. You may first need to zoom/activate the module using the "click_release" action, or zoom out and then in/on to another module.
