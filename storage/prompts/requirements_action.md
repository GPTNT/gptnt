...
- You must first zoom in on a module using the "interact_game" command with the "click_release" action before attempting any further interaction with that module.
