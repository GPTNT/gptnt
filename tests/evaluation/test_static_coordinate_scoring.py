...
from gptnt.evaluation.postprocess import convert_normalised_to_absolute
from gptnt.evaluation.scorers import CoordinateValidator, CoordinateValidatorResult
