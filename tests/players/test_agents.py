...
# def test_provide_message_to_agent(player: AIPlayer) -> None:
#     agent = player.agent
...
# async def test_functional_model_does_not_crash(player: AIPlayer) -> None:
#     for _ in range(30):
#         with player.agent.override(model=DummyDefuserModel()):
#             response = await player.send_request_to_agent(message_input="message")
...
#     player: AIPlayer, bomb_state_message: BombStateMessage, mocker: MockerFixture
# ) -> None:
...
#     player: AIPlayer, mocker: MockerFixture
# ) -> None:
#     # mock receiving the bomb state as a message
#     player.pull_unread_messages_from_dialogue_space = mocker.AsyncMock()
...
#     player: AIPlayer, mocker: MockerFixture, binary_image_content: BinaryContent
# ) -> None:
#     with player.agent.override(model=DummyDefuserModel()):
#         player.build_agent_input = mocker.AsyncMock()
