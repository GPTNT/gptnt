...
def test_ai_player_config_is_valid(ai_player: str) -> None:
    ...
    config = load_hydra_config(
        ...
        overrides=[f"player=ai/{ai_player}", "model=test"],
    )

    assert config


def test_ai_player_can_instantiate_from_config(ai_player: str) -> None:
