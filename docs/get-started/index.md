...
- If you want to dig in and understand how the benchmark works and how to build on top of it, check out [Concepts](/concepts).
...
- [ ] How to run the game and the benchmark end-to-end (quickstart)
- [ ] How to configure the game settings (sound, resolution, language, speed)
- [ ] A taxonomy/glossary of terminology
